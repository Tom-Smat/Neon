...
contract NeonVaultDistribution is Owned, TokensRecoverable, INeonVaultDistribution
{
    ...
    uint256 public totalNeonSupplyForLge;
    ...
    function setupNethNeonVault() public
    {
    ...
    function distribute() public override payable
    {
        ...
        totalNeonSupplyForLge = neonVault.balanceOf(msg.sender);

        neonVault.transferFrom(msg.sender, address(this), totalNeonSupplyForLge);
    ...
    function createNethNeonVaultLiquidity(uint256 totalEth) private
    {
        ...
        (,,totalNethNeonVault) = uniswapV2Router.addLiquidity(address(neth), address(neonVault), neth.balanceOf(address(this)), totalNeonSupplyForLge, 0, 0, address(this), block.timestamp);
    ...
    function getTotalNeonSupplyForLge() public override view returns (uint256) { 
        return totalNeonSupplyForLge;
    }
}