...
contract ENV_staking is Ownable {
    ...
    function stakeTokens(uint256 amount) external {
        require(initialAmount != 0, "invalid time to start");
        ...
        uint256 _amountToCharge = amountToCharge(amount);
        uint256 _amountToTransfer = amount - _amountToCharge;
